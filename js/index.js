...
tl.to(
  "#Center_triangle #ct_top, #ct_mask_top",
  {
    x: -340,
    duration: 3.5,
    ease: "none"
...
/* COLORS */
tl.to(
  "#br_top, #br_bottom, #br_right, #br_left, #left_circle2",
  {
    stroke: red,
    duration: 3,
    ease: "power2.inOut"
